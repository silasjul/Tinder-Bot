...
model_path = "./model/hotornot_classifier.pt"
...
test_size = len(ds) - train_size - val_size  # Remaining 15% for testing
...
if __name__ == "__main__":
    ...
    test_model(visualize_wrong_predictions=True, visualize_correct_predictions=True)