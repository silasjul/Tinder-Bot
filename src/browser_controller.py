...
class BrowserController():
    ...
    def get_girl_img(self):
        img = self.wait.until(EC.presence_of_element_located((By.XPATH, "//div[@aria-label='Profile Photo 1']")))
    ...
    def close_superlike_popup(self):
        try:
            superlike_close_btn = self.driver.find_element(By.XPATH, "//button[.//div[text()='No Thanks']]") 
            superlike_close_btn.click()
        except selenium.common.exceptions.NoSuchElementException:
            pass
